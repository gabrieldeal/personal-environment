(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			global:		{ range: '*', href: 'home/css/style.css', containers: 1400, grid: { gutters: 50 } },
		...
		layers: {
			layers: {
				...
				titleBar: {
					breakpoints: 'narrower',
					height: 44,
                                        html: '<span class="turned-off toggle" data-action="toggleLayer" data-args="navPanel"></span><span class="title" data-action="copyHTML" data-args="logo"></span>',
					position: 'top-left',
					side: 'top',
					width: '100%'
				}
